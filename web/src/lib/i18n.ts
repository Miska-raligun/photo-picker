...
const enMessages = {
  en: {
    ...
    detail: {
      ...
      lightboxHint: "scroll / double-click · drag · ← → navigate · I details · Space keep/drop · ESC close",
...
export const messages: Record<Lang, Messages> = {
  ...
  zh: {
    ...
    detail: {
      ...
      lightboxHint: "滚轮缩放 / 双击 · 拖动 · ← → 翻页 · I 详情 · 空格 保留/删除 · ESC 关闭",
      toggleDetails: "详情面板",
      detailsTitle: "详情",
      algoRank: "算法排名",
      aiReasonLabel: "AI 解读",
